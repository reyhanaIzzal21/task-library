...
@section('content')
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-sm text-gray-500">Buku yang sedang dalam proses peminjaman</p>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left px-6 py-4 text-sm font-semibold text-gray-600">Jatuh Tempo</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($borrowings as $borrowing)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="{{ $borrowing->due_date->isPast() && $borrowing->status === 'borrowed' ? 'text-red-600 font-medium' : 'text-gray-600' }}">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <a href="{{ route('books.index') }}"
                                    class="text-blue-600 hover:underline text-sm mt-2 inline-block">Cari buku untuk
                                    dipinjam</a>
                            </td>
                        </tr>
                    @endforelse
